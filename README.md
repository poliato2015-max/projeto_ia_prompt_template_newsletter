...
Markdown**Informações Gerais (obrigatórias)**
- SEMANA/DATA: 
- TEMA GERAL: 
...
✅ Exemplo de Uso
Markdown**Dados de entrada (preenchidos por quem está solicitando):**
...
Cole em qualquer IA (ChatGPT, Grok, Claude, etc.)
No final do prompt, cole o Formulário de Entrada preenchido
Execute e receba a newsletter pronta para publicar
